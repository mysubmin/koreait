...
public class DeptController {
    ...
    @PostMapping("/login")
    public String getLoginDo(@ModelAttribute RegisterDto registerDto, HttpServletRequest req) {
        RegisterDto reDto = registerMapper.getLoginDo(registerDto);
           if(reDto == null) {
               return  "redirect:/emp/register";
           }else{
               HttpSession hs =  req.getSession();
               hs.setAttribute("sessInfo", reDto);
    ...
    public String getLogout(HttpSession session) {
        ...
        System.out.println("로그아웃을 되었습니다.");
        return "redirect: /emp/login";
    }

    @GetMapping("/main")
    public String getMain() { return "admin/main"; }
